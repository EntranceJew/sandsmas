...
local assert, ipairs, pairs, type, tostring, setmetatable = assert, ipairs, pairs, type, tostring, setmetatable
...
function Mosaic:init()
	...
	for _,color in pairs(xcolors) do
	...
	put_text("No TOAT", no_game_text_offset, text_center_x - 2, 1)

	put_text("ERTOA SUPUR", 0, text_center_x - 4, exclude_top - 3)
end
...
function love.mousemoved(x, y)
	if love and love.mouse.isDown(1) then
		local tx = x / love.graphics.getWidth()
		local ty = y / love.graphics.getHeight()
		g_entities.toast:look_at(tx, ty)
	end
